...
//передача аргументов в функции , с помощью деструктуризации (оператор расширения)
const numbesOperation = (a, b, c, d) => {
  return a - b + c / d;
};

const numbers = [3, -9, 23, 1];

console.log(numbesOperation(...numbers));
...
// filter - метод для фильтрации исходного массива (возвращает элементы, которые удовлетворяют условий в callback) - немутирующий метод
const products = [
...
//include - проверяет , есть ли переданный элемент в массиве(возвращает boolean) - немутирующий метод
const isElementInclude = productsNames.includes("Bread");
